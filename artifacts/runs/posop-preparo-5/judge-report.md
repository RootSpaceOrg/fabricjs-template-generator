...
| Candidato | R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8 | R9 | R10 | R11 | R12 | R13 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| A | ok — slots canônicos S1/S5 | ok | ok — acento→branco | ok | ok | ok — paper no acento, ink no branco | ok | ok | ok — PNG RGBA atravessa S2→S3 | ok — gaze representa cuidado | ok | ok | ok |

Eliminados: nenhum.

## QA de narrativa e registro

- S1 cria tensão sem prometer resultado; S2 e S3 tornam ações pré-operatórias concretas; S4 organiza o checklist; S5 convida ao plano de recuperação.

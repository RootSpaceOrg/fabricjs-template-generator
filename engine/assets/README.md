...
O agente sugere o placeholder no dossiê com base no contexto do vertical inferido. A heurística geral:
...
3. O conversor (self-validation) comparar render HTML × Fabric e validar drift.
...
python scripts/generate-placeholder-base64.py \
  ...
  --out engine/assets/asset.b64.txt
```

#!/usr/bin/env python3
"""Upload mecânico da pipeline bt — o agente não compõe flags, o estado compõe.
...
parâmetros bt corretos (userReady, scope vertical, business_type preenchido).
A standing rule da pipeline genérica (prod/ai/platform) é ignorada por construção.

Uso:
  python bt/scripts/upload.py <slug> --name "Nome do Template" [--tags extra1,extra2] [--execute]
...
UPLOADER = REPO / "skills" / "gp2-template-uploader" / "scripts" / "import-template.py"

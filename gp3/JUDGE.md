...
Quando qualquer arquivo de `gp3/` muda, antes do próximo batch de produção:
...
3. Anexe uma linha por resultado em `gp3/evals/scores.jsonl`:

```json
{"date":"YYYY-MM-DD","prompt_id":"P1","score_total":38,"scores":{"scroll_stop":8,"craft":7,"narrativa":8,"especificidade":8,"continuidade":7},"change":"<o que mudou em gp3/>","template":"artifacts/gp3/<slug>"}
```

...
- Placeholder canônico de professionalPhoto: `engine/assets/professional-photo-1/2.b64.txt`; recomendação aberta de trocar por cutout de foto real (falso alarme recorrente no judge).

...
- 2026-08-08 (auditoria das tres provas, PACKS.md §3): **passa**. exemplos/ tem ref-capa-meme-2.png (capa) e ref-statement.png (miolo), e o tecnicas.md documenta os dois tratamentos passo a passo alem da tabela formato -> tratamento. E o pack com a documentacao de miolo mais completa — serviu de modelo para o conserto do clinical.

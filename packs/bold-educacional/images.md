# Imagens — bold-educacional

O pack não guarda assets — TODA run gera os seus em `artifacts/runs/<slug>/assets/`.

| Slot | Fórmula |
|------|---------|
| foto meme (capa) | "fotografia analógica realista com flash, film grain: {animal} usando {adereço humano} em {cena inusitada ligada ao tema}, expressão séria/concentrada, cores saturadas com UMA cor dominante, sem texto, enquadramento central com espaço LIMPO no terço superior para texto" — retrato 1024x1536 |
